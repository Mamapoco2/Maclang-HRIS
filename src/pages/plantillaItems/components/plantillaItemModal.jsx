...
// ── Hierarchy helpers ───────────────────────────────────────────────────────
function resolveUnitForDepartment(dept) {
  if (dept?.division) {
    return {
      ...dept.division,
...
function departmentsUnderUnit(departmentUnits, unit) {
...
// ── HierarchyTargetField — cascading Directorate/Division -> Department ────
function HierarchyTargetField({ units, loading, value, onChange }) {
