...
export function CancelRequestModal({ request, onClose, onSave, submitting }) {
  ...
  function handleSubmit(e) {
    ...
    if (!trimmed) {
      setError("Please provide a reason for cancelling this leave request.");
      return;
    }
    onSave(trimmed);
  }
      ...
      >
        ...
        <form onSubmit={handleSubmit}>
          ...
          <textarea
            ...
            placeholder="e.g. No longer needed, plans changed…"
            rows={4}
          ...
          >
            ...
            >
              {submitting ? "Cancelling…" : "Cancel this leave"}
            </button>
          </div>
        </form>
      </div>
