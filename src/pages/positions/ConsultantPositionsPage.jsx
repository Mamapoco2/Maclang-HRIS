...
import { Plus, Search, LayoutList, Briefcase, Clock } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-400 mt-0.5">
              Manage Consultant position titles
            </p>
          </div>
        </div>
        ...
        <Button
          ...
          className="bg-violet-600 hover:bg-violet-700 text-white text-sm h-9 px-4 shrink-0"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 px-6 py-5">
        <div className="rounded-xl border border-gray-100 bg-white px-4 py-4 flex items-center gap-3">
          <div className="shrink-0 w-9 h-9 rounded-lg bg-violet-50 flex items-center justify-center">
            <LayoutList size={16} strokeWidth={2} className="text-violet-600" />
          </div>
          <div>
        ...
        <div className="rounded-xl border border-gray-100 bg-white px-4 py-4 flex items-center gap-3">
          <div className="shrink-0 w-9 h-9 rounded-lg bg-indigo-50 flex items-center justify-center">
            <Briefcase size={16} strokeWidth={2} className="text-indigo-600" />
          </div>
          <div>
            <div className="text-2xl font-semibold text-gray-900 font-mono leading-none">
              {loading ? "—" : positions.length}
