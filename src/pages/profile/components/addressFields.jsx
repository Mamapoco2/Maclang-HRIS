...
// ─── Height Field ─────────────────────────────────────────────────────────────
// Uses type="text" so it accepts any value from PDS import without browser
// validation errors. The usePdsExtract hook already converts all formats
// (5'11", 165cm, 1.65m) to a plain decimal metres string e.g. "1.65".
// The user can also type freely and we just pass the value through.
