const PH_BARANGAYS_BY_PROVINCE_CITY = {
  Abra: {
    Bangued: [
      "Agtangao",
      "Angad",
    ...
    Bucloc: ["Ducligan", "Labaan", "Lamao (Poblacion)", "Lingay"],
    Daguioman: ["Ableg", "Cabaruyan", "Pikek", "Tui (Poblacion)"],
    Danglas: [
      "Abaquid",
      "Cabaruan",
      "Caupasan (Poblacion)",
  ...
  Albay: {
    ...
    "Legazpi City": [
      "Bgy. 1 - Em'S Barrio (Poblacion)",
      "Bgy. 10 - Cabugao",
      "Bgy. 11 - Maoyod Pob. (Bgy. 10 And 11)",
      "Bgy. 12 - Tula-Tula (Poblacion)",
      "Bgy. 13 - Ilawod West Pob. (Ilawod 1)",
      "Bgy. 14 - Ilawod Pob. (Ilawod 2)",
      "Bgy. 15 - Ilawod East Pob. (Ilawod 3)",
      "Bgy. 16 - Kawit-East Washington Drive (Poblacion)",
      "Bgy. 17 - Rizal Sreet., Ilawod (Poblacion)",
      "Bgy. 18 - Cabagñan West (Poblacion)",
      "Bgy. 19 - Cabagñan",
      "Bgy. 2 - Em'S Barrio South (Poblacion)",
      "Bgy. 20 - Cabagñan East (Poblacion)",
      "Bgy. 21 - Binanuahan West (Poblacion)",
      "Bgy. 22 - Binanuahan East (Poblacion)",
      "Bgy. 23 - Imperial Court Subd. (Poblacion)",
      "Bgy. 24 - Rizal Street",
      "Bgy. 25 - Lapu-Lapu (Poblacion)",
      "Bgy. 26 - Dinagaan (Poblacion)",
      "Bgy. 27 - Victory Village South (Poblacion)",
      "Bgy. 28 - Victory Village North (Poblacion)",
      "Bgy. 29 - Sabang (Poblacion)",
      "Bgy. 3 - Em'S Barrio East (Poblacion)",
      "Bgy. 30 - Pigcale (Poblacion)",
      "Bgy. 31 - Centro-Baybay (Poblacion)",
      "Bgy. 32 - San Roque (Bgy. 66)",
      "Bgy. 33 - Pnr-Peñaranda St.-Iraya (Poblacion)",
      "Bgy. 34 - Oro Site-Magallanes St. (Poblacion)",
      "Bgy. 35 - Tinago (Poblacion)",
      "Bgy. 36 - Kapantawan (Poblacion)",
      "Bgy. 37 - Bitano (Poblacion)",
      "Bgy. 38 - Gogon (Bgy. 54)",
      "Bgy. 39 - Bonot (Poblacion)",
      ...
      "Bgy. 7 - Baño (Poblacion)",
      "Bgy. 70 - Cagbacong (Bgy. 50)",
      "Bgy. 8 - Bagumbayan (Poblacion)",
      "Bgy. 9 - Pinaric (Poblacion)",
    ],
    Libon: [
      "Alongong",
      "Apud",
    ...
    Malilipot: [
      ...
      "Canaway",
      "Salvacion",
      "San Antonio Santicon (Poblacion)",
      "San Antonio Sulong",
      "San Francisco",
      "San Isidro Ilawod",
      "San Isidro Iraya",
    ...
    Polangui: [
      ...
      "Binagbangan (Pintor)",
      "Buyo",
      "Centro Occidental (Poblacion)",
      "Centro Oriental (Poblacion)",
      "Cepres",
      "Cotmon",
      "Cotnogan",
      "Danao",
  ...
  Antique: {
    ...
    Bugasong: [
      ...
      "Bagtason",
      "Camangahan",
      "Centro Ilawod (Poblacion)",
      "Centro Ilaya (Poblacion)",
      "Centro Pojo (Poblacion)",
      "Cubay North",
      "Cubay South",
      "Guija",
      "Igbalangao",
    ...
    Libertad: [
      "Barusbus",
      "Bulanao",
      "Centro Este (Poblacion)",
      "Centro Weste (Poblacion)",
      "Codiong",
      "Cubay",
      "Igcagay",
      "Inyawan",
  ...
  Basilan: {
    ...
    "Isabela City": [
      ...
      "Isabela Eastside (Poblacion)",
      "Isabela Proper (Poblacion)",
      "Kapatagan Grande",
      "Kapayawan",
      "Kaumpurnah Zone I",
      "Kaumpurnah Zone II",
  ...
  Bataan: {
    ...
    Orani: [
      ...
      "Mulawin",
      "Pag-Asa",
      "Paking-Carbonero (Poblacion)",
      "Palihan (Poblacion)",
      "Pantalan Bago (Poblacion)",
      "Pantalan Luma (Poblacion)",
      "Parang Parang (Poblacion)",
      "Puksuan",
      "Sibul",
      "Silahis",
      "Tagumpay",
    ...
    Orion: [
      ...
      "Calungusan",
      "Camachile",
      "Daang Bago (Poblacion)",
      "Daang Bilolo (Poblacion)",
      "Daang Pare",
      "General Lim (Kaput)",
      "Kapunitan",
      "Lati (Poblacion)",
  ...
  Batanes: {
    ...
    Ivana: ["Radiwan", "Salagao", "San Vicente (Igang)", "Tuhel (Poblacion)"],
    Mahatao: ["Hanib", "Kaumbakan", "Panatayan", "Uvoy (Poblacion)"],
    Sabtang: [
      "Chavayan",
      "Malakdang (Poblacion)",
      "Nakanmuan",
  ...
  Biliran: {
    ...
    Culaba: [
      ...
      "Bacolod",
      "Binongtoan",
      "Bool Central (Poblacion)",
      "Bool East (Poblacion)",
      "Bool West (Poblacion)",
      "Calipayan",
      "Culaba Central (Poblacion)",
      "Guindapunan",
      "Habuhab",
      "Looc",
      "Marvel (Poblacion)",
  ...
  "Camarines Sur": {
    ...
    Pasacao: [
      ...
      "Salvacion",
      "San Antonio",
      "San Cirilo (Poblacion)",
      "Santa Rosa Del Norte (Poblacion)",
      "Santa Rosa Del Sur (Poblacion)",
      "Tilnac",
      "Tinalmud",
    ],
    Pili: [
  ...
  Cavite: {
    ...
    "Imus City": [
      ...
      "Pasong Buaya II",
      "Pinagbuklod",
      "Poblacion I-A (Poblacion)",
      "Poblacion I-B",
      "Poblacion I-C",
      "Poblacion Ii-A (Poblacion)",
      "Poblacion Ii-B",
      "Poblacion Iii-A (Poblacion)",
      "Poblacion Iii-B",
      "Poblacion Iv-A (Poblacion)",
      "Poblacion Iv-B",
      "Poblacion Iv-C",
      "Poblacion Iv-D",
      "Tanzang Luma I",
  ...
  Cebu: {
    ...
    "Bogo City": [
      ...
      "Guadalupe",
      "La Paz",
      "La Purisima Concepcion (Poblacion)",
      "Libertad",
      "Lourdes (Poblacion)",
      "Malingin",
      "Marangog",
    ...
    "Cebu City": [
      ...
      "Cambinocot",
      "Camputhaw (Poblacion)",
      "Capitol Site (Poblacion)",
      "Carreta",
      "Central (Poblacion)",
      "Cogon Pardo",
      "Cogon Ramos (Poblacion)",
      "Day-As",
      "Duljo (Poblacion)",
      "Ermita (Poblacion)",
      "Guadalupe",
  ...
  "Ilocos Norte": {
    ...
    Bacarra: [
      ...
      "Pulangi",
      "Pungto",
      "San Agustin I (Poblacion)",
      "San Agustin II (Poblacion)",
      "San Andres I (Poblacion)",
      "San Andres II (Poblacion)",
      "San Gabriel I (Poblacion)",
      "San Gabriel II (Poblacion)",
      "San Pedro I (Poblacion)",
      "San Pedro II (Poblacion)",
      "San Roque I (Poblacion)",
      "San Roque II (Poblacion)",
      "San Simon I (Poblacion)",
      "San Simon II (Poblacion)",
      "San Vicente (Poblacion)",
      "Sangil",
      "Santa Filomena I (Poblacion)",
      "Santa Filomena II (Poblacion)",
      "Santa Rita (Poblacion)",
      "Santo Cristo I (Poblacion)",
      "Santo Cristo II (Poblacion)",
      "Tambidao",
      "Teppang",
      "Tubburan",
    ],
    ...
    Carasi: ["Angset", "Barbaqueso (Poblacion)", "Virbira"],
    Currimao: [
      "Anggapang Norte",
      "Anggapang Sur",
      "Bimmanga",
    ...
    "Laoag City": [
      "Bgy. No. 1, San Lorenzo (Poblacion)",
      "Bgy. No. 10, San Jose (Poblacion)",
      "Bgy. No. 11, Santa Balbina (Poblacion)",
      "Bgy. No. 12, San Isidro (Poblacion)",
      "Bgy. No. 13, Nstra. Sra. De Visitacion (Poblacion)",
      "Bgy. No. 14, Santo Tomas (Poblacion)",
      "Bgy. No. 15, San Guillermo (Poblacion)",
      "Bgy. No. 16, San Jacinto (Poblacion)",
      "Bgy. No. 17, San Francisco (Poblacion)",
      "Bgy. No. 19, Santa Marcela (Poblacion)",
      "Bgy. No. 2, Santa Joaquina (Poblacion)",
      "Bgy. No. 20, San Miguel (Poblacion)",
      "Bgy. No. 21, San Pedro (Poblacion)",
      "Bgy. No. 22, San Andres (Poblacion)",
      "Bgy. No. 23, San Matias (Poblacion)",
      "Bgy. No. 24, Nstra. Sra. De Consolacion (Poblacion)",
      "Bgy. No. 25, Santa Cayetana (Poblacion)",
      "Bgy. No. 26, San Marcelino (Poblacion)",
      "Bgy. No. 27, Nstra. Sra. De Soledad (Poblacion)",
      "Bgy. No. 28, San Bernardo (Poblacion)",
      "Bgy. No. 29, Santo Tomas (Poblacion)",
      "Bgy. No. 3, Nstra. Sra. Del Rosario (Poblacion)",
      "Bgy. No. 30-A, Suyo",
      ...
      "Bgy. No. 4, San Guillermo (Poblacion)",
      "Bgy. No. 40, Balatong",
      "Bgy. No. 41, Balacad",
      "Bgy. No. 42, Apaya",
      "Bgy. No. 43, Cavit",
      ...
      "Bgy. No. 6, San Agustin (Poblacion)",
      "Bgy. No. 60-A, Caaoacan",
      "Bgy. No. 60-B, Madiladig",
      "Bgy. No. 61, Cataban",
      "Bgy. No. 62-A, Navotas North",
      "Bgy. No. 62-B, Navotas South",
      "Bgy. No. 7-A, Nstra. Sra. De Natividad (Poblacion)",
      "Bgy. No. 7-B, Nstra. Sra. De Natividad (Poblacion)",
      "Bgy. No. 8, San Vicente (Poblacion)",
      "Bgy. No. 9, Santa Angela (Poblacion)",
      "Bry. No. 18, San Quirino (Poblacion)",
    ...
    "San Nicolas": [
      "San Agustin",
      "San Baltazar (Poblacion)",
      "San Bartolome (Poblacion)",
      "San Cayetano (Poblacion)",
      "San Eugenio (Poblacion)",
      ...
      "San Paulo (Poblacion)",
      "San Pedro (Bingao)",
      "San Rufino (Poblacion)",
      "San Silvestre (Poblacion)",
  ...
  Iloilo: {
    ...
    Dumangas: [
      ...
      "Baras",
      "Barasan",
      "Basa-Mabini Bonifacio (Poblacion)",
      "Bolilao",
      "Buenaflor Embarkadero (Poblacion)",
    ...
    Guimbal: [
      ...
      "Balantad-Carlos Fruto (Poblacion)",
      "Baras",
      "Binanua-An",
      "Bongol San Miguel",
      "Bongol San Vicente",
      "Bulad",
      "Buluangan",
      "Burgos-Gengos (Poblacion)",
      "Cabasi",
      "Cabubugan",
      "Calampitao",
      "Camangahan",
      "Generosa-Cristobal Colon (Poblacion)",
      "Gerona-Gimeno (Poblacion)",
      "Girado-Magsaysay (Poblacion)",
      "Gotera (Poblacion)",
      "Igcocolo",
      "Iyasan",
      "Libo-On Gonzales (Poblacion)",
      "Lubacan",
      "Nahapay",
      "Nalundan",
      "Nanga",
      ...
      "Rizal-Tuguisan (Poblacion)",
      "Santa Rosa-Laguna",
      "Sipitan-Badiang",
      "Torreblanca-Blumentritt (Poblacion)",
    ],
    Igbaras: [
      "Alameda",
      "Amorogtong",
    ...
    Pototan: [
      ...
      "Pitogo",
      "Polot-An",
      "Primitivo Ledesma Ward (Poblacion)",
      "Purog",
      "Rumbang",
  ...
  Isabela: {
    ...
    "Reina Mercedes": [
      ...
      "District I (Poblacion)",
      "District II (Poblacion)",
      "Labinab Grande (Poblacion)",
      "Labinab Pequeño (Poblacion)",
      "Mallalatang Grande",
      "Mallalatang Tunggui",
      "Napaccu Grande",
      "Napaccu Pequeño",
    ...
    "Santiago City": [
      ...
      "Buenavista",
      "Cabulay",
      "Calao East (Poblacion)",
      "Calao West (Poblacion)",
      "Calaocan",
      "Centro East (Poblacion)",
      "Centro West (Poblacion)",
      "Divisoria",
  ...
  Laguna: {
    ...
    Paete: [
      ...
      "Bangkusay (Poblacion)",
      "Ermita (Poblacion)",
      "Ibaba Del Norte (Poblacion)",
      "Ibaba Del Sur (Poblacion)",
      "Ilaya Del Norte (Poblacion)",
      "Ilaya Del Sur (Poblacion)",
      "Maytoong (Poblacion)",
      "Quinale (Poblacion)",
    ],
    Pagsanjan: [
    ...
    "San Pablo City": [
      "Atisan",
      "Bagong Bayan Ii-A (Poblacion)",
      "Bagong Pook Vi-C (Poblacion)",
      "Barangay I-A (Poblacion)",
      "Barangay I-B (Poblacion)",
      "Barangay Ii-A (Poblacion)",
      "Barangay Ii-B (Poblacion)",
      "Barangay Ii-C (Poblacion)",
      "Barangay Ii-D (Poblacion)",
      "Barangay Ii-E (Poblacion)",
      "Barangay Ii-F (Poblacion)",
      "Barangay Iii-A (Poblacion)",
      "Barangay Iii-B (Poblacion)",
      "Barangay Iii-C (Poblacion)",
      "Barangay Iii-D (Poblacion)",
      "Barangay Iii-E (Poblacion)",
      "Barangay Iii-F (Poblacion)",
      "Barangay Iv-A (Poblacion)",
      "Barangay Iv-B (Poblacion)",
      "Barangay Iv-C (Poblacion)",
      "Barangay V-A (Poblacion)",
      "Barangay V-B (Poblacion)",
      "Barangay V-C (Poblacion)",
      "Barangay V-D (Poblacion)",
      "Barangay Vi-A (Poblacion)",
      "Barangay Vi-B (Poblacion)",
      "Barangay Vi-D (Poblacion)",
      "Barangay Vi-E (Poblacion)",
      "Barangay Vii-A (Poblacion)",
      "Barangay Vii-B (Poblacion)",
      "Barangay Vii-C (Poblacion)",
      "Barangay Vii-D (Poblacion)",
      "Barangay Vii-E (Poblacion)",
      "Bautista",
      "Concepcion",
      "Del Remedio",
      "Dolores",
  ...
  Leyte: {
    ...
    Hilongos: [
      ...
      "Catandog 1",
      "Catandog 2",
      "Central Barangay (Poblacion)",
      "Concepcion",
      "Eastern Barangay (Poblacion)",
      "Hampangan",
      "Himo-Aw",
      "Hitudpan",
  ...
  "Misamis Oriental": {
    ...
    "Gingoog City": [
      ...
      "Barangay 17 (Poblacion)",
      "Barangay 18 (Poblacion)",
      "Barangay 18-A (Poblacion)",
      "Barangay 19 (Poblacion)",
      "Barangay 2 (Poblacion)",
      "Barangay 20 (Poblacion)",
      "Barangay 21 (Poblacion)",
      "Barangay 22 (Poblacion)",
      "Barangay 22-A (Poblacion)",
      "Barangay 23 (Poblacion)",
      "Barangay 24 (Poblacion)",
      "Barangay 24-A (Poblacion)",
      "Barangay 25 (Poblacion)",
      "Barangay 26 (Poblacion)",
      "Barangay 3 (Poblacion)",
      "Barangay 4 (Poblacion)",
  ...
  "Northern Samar": {
    ...
    Catarman: [
      ...
      "Imelda (Elimbo)",
      "Ipil-Ipil (Poblacion)",
      "Jose Abad Santos (Poblacion)",
      "Jose P. Rizal (Poblacion)",
      "Kasoy (Poblacion)",
      "Lapu-Lapu (Poblacion)",
      "Liberty",
      "Libjo (Binog)",
    ...
    Gamay: [
      ...
      "Dao",
      "G. M. Osias",
      "Gamay Central (Poblacion)",
      "Gamay Occidental I (Poblacion)",
      "Gamay Oriental I (Poblacion)",
      "Guibuangan",
      "Henogawe",
      "Libertad (Poblacion)",
      "Lonoy",
  ...
  "Nueva Ecija": {
    ...
    Jaen: [
      ...
      "Marawa",
      "Niyugan",
      "Ocampo-Rivera District (Poblacion)",
      "Pakol",
      "Pamacpacan",
      "Pinanggaan",
      "Putlod",
  ...
  Pangasinan: {
    ...
    Mangatarem: [
      ...
      "Malunec",
      "Maravilla (Poblacion)",
      "Maravilla-Arellano Ext. (Poblacion)",
      "Muelang",
      "Naguilayan East",
      "Naguilayan West",
      "Nancasalan",
  ...
  Samar: {
    ...
    "Calbayog City": [
      "Acedillo",
      "Aguit-Itan (Poblacion)",
      "Alibaba",
      "Amampacang",
      "Anislag",
      "Awang East (Poblacion)",
      "Awang West (Poblacion)",
      "Ba-Ay",
      "Bagacay",
      "Bagong Lipunan",
      "Baja",
  ...
  "Tawi-Tawi": {
    ...
    "Turtle Islands": ["Likud Bakkao", "Taganak Poblacion"],
  },
  Zambales: {
    Botolan: [
      "Bancal",
  ...
  "Zamboanga del Norte": {
    ...
    Siayan: [
      ...
      "Muñoz",
      "Pange",
      "Paranglumba (Poblacion)",
      "Polayo",
      "Sayaw",
      "Seriac",
      "Siayan Proper (Poblacion)",
      "Suguilon",
    ],
    Sibuco: [
      "Anongan",
